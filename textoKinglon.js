...
-> As letras Klingon são classificadas em dois grupos: 
      as letras s, l, f, w e k são chamadas "letras tipo foo", 
      enquanto que as demais são conhecidas como "letras tipo bar".

Os linguistas descobriram que:
      as preposições em Klingon são as palavras de 3 letras que terminam numa letra tipo bar, mas onde não ocorre a letra d. 
...
console.log('--- ----  Função Preposição Kinglon  --- ---\n');
...
console.log(DecifradorKinglon(txtA).totalPreposicoesKinglon);
