...
const alfabetoComum = 'a b c d e f g h i j k l m n o p q r s t'.split(' ');
...
Recebe como parametro:
  - ArrayDeFrases = Um Array de frase em String
  - alfaComun = Um Array de caracteres contendo Alfabeto Comum,
  - alfaAntigo = Um Array de caracteres contendo o Alfabeto Antigo;

Transforma cada caractere da Frase do alfabeto Antigo em caracteres do Alfabeto Comum respeitando a posição de cada caractere correspondente
    alfabetoKlingon = 'k b w r q d n f x j m l v h t c g z p s'
    alfabetoComum   = 'a b c d e f g h i j k l m n o p q r s t'

Adiciona cada Frase Transformada em um novoArrayDeFrases e Ordena este Array em ordem alfabetica comum.
Retorna o valor final do Array novoArrayDeFrases.     
*/
...
/*DescriptographKlingon
Recebe como parametro:
  - ArrayDeFrases = Um Array de frase em String
  - alfaComun = Um Array de caracteres contendo Alfabeto Comum,
  - alfaAntigo = Um Array de caracteres contendo o Alfabeto Antigo;

Realiza o processo inverso da função CriptographKlingon
Transformando cada caractere da Frase do alfabeto Comum em caracteres do Alfabeto Angigo respeitando a posição de cada caractere correspondente
    alfabetoComum   = 'a b c d e f g h i j k l m n o p q r s t'
    alfabetoKlingon = 'k b w r q d n f x j m l v h t c g z p s'
Adiciona cada Frase Transformada em um novoArrayDeFrases e Ordena este Array em ordem alfabetica comum.
Retorna o valor final do Array novoArrayDeFrases.     
